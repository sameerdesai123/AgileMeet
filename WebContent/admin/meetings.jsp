...
<%@ page import="com.agilemeet.admin.model.MeetingInfo, java.util.*" %>
...
<body>
	...
	%>
	<%
		List<MeetingInfo> meetings = (List<MeetingInfo>) session.getAttribute("meetings");
...
<div class="container p-5">
	<div class="p-5 shadow bg-white">
		<table id="meetingsTable" class="table table-striped table-hover table-bordered table-sm" cellspacing="0" width="100%">
			<thead >
				<tr>
